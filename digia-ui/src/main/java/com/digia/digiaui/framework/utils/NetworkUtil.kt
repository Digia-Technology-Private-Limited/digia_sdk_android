...
/**
 * Execute API action with success/error callbacks using ApiHandler
 */
suspend fun executeApiAction(
    ...
    try {
        ...
        val response = ApiHandler.execute(
            apiModel = apiModel,
            args = evaluatedArgs,
        ...
        val isSuccess = if (successCondition != null) {
